...
class ConfigManager:
    ...
    def _define_settings(self) -> Dict[str, ConfigSetting]:
        ...
        settings['AM_W_SEMANTIC'] = ConfigSetting(
            ...
            default_value=0.84,
            current_value=float(os.getenv('AM_W_SEMANTIC', '0.84')),
            category='Weights',
            editable=True,
            requires_restart=False,
            min_value=0.0,
        ...
        settings['AM_MEMORY_BUDGET'] = ConfigSetting(
            ...
            default_value=20480,
            current_value=int(os.getenv('AM_MEMORY_BUDGET', '20480')),
            category='Memory',
            editable=True,
            requires_restart=False,
            min_value=100,
        ...
        settings['AM_CONTEXT_WINDOW'] = ConfigSetting(
            ...
            type=ConfigType.INTEGER,
            default_value=20480,
            current_value=int(os.getenv('AM_CONTEXT_WINDOW', '20480')),
            category='LLM',
            editable=True,
            requires_restart=False,
            min_value=2048,
        ...
        settings['AM_EMBED_DIM'] = ConfigSetting(
            ...
            type=ConfigType.INTEGER,
            default_value=1024,
            current_value=int(os.getenv('AM_EMBED_DIM', '1024')),
            category='System',
            editable=False,
            requires_restart=True
        )
